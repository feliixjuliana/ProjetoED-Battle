...
time.sleep(2.5)
print("Forjado na disciplina, treinado em honra e armado com a espada de prata ancestral: o Herói Escolhido.")
time.sleep(3)
...
print("E assim...")
time.sleep(2)
print("🔥 A batalha entre o Herói e o Goblin começa!")
time.sleep(3)
print("=" * 50)
